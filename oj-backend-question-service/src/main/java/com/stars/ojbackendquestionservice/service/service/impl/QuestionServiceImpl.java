...
import com.stars.ojbackendquestionservice.service.mapper.QuestionMapper;
...
import com.stars.ojbackendmodel.model.dto.question.QuestionQueryRequest;
...
public class QuestionServiceImpl extends ServiceImpl<QuestionMapper, Question>
    ...
    public QuestionVO getQuestionVO(Question question, HttpServletRequest request) {
        ...
        if (userId != null && userId > 0) {
            user = userFeginClient.getById(userId);
        }
        UserVO userVO = userFeginClient.getUserVO(user);
    ...
    public Page<QuestionVO> getQuestionVOPage(Page<Question> questionPage, HttpServletRequest request) {
        ...
        Map<Long, List<User>> userIdUserListMap = userFeginClient.listByIds(userIdSet).stream()
        ...
        List<QuestionVO> questionVOList = questionList.stream().map(question -> {
            ...
            questionVO.setUserVO(userFeginClient.getUserVO(user));
            return questionVO;
